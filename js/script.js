(function($) {
	...
	//31.1. Western Donate Popup
	function wasterndonatepopup() {	
		if($('#wastern-donate-popup').length){
			
			//Show Popup
			$('.wastern-donate-box-btn').on('click', function() {
				$('#wastern-donate-popup').addClass('popup-visible');
			});
			
			//Hide Popup
			$('.close-donate').on('click', function() {
				$('#wastern-donate-popup').removeClass('popup-visible');
			});
		}
	}
